...
import com.clone.kakaoclone.repository.AddChatRoomRepository;
...
public class AddChatRoomService {
    private final AddChatRoomRepository addChatRoomRepository;
    ...
    public void createEmptyChatRoom(ChatRoomRequestDto chatRoomRequestDto, UserDetailsImpl userDetails) {
        ...
        ChatRoom chatRoom = ChatRoom.builder()
                ...
                .build();
        addChatRoomRepository.save(chatRoom);
    ...
    public void inviteFriend(Long chatRoomId, Long friendId, UserDetailsImpl userDetails) {
        Member member = userDetails.getMember();
        ChatRoom chatRoom = addChatRoomRepository.findById(chatRoomId)
    ...
    public List<AddChatRoomResponseDto> readAllChatRoom(UserDetailsImpl userDetails) {
        Member member = userDetails.getMember();
        ...
        List<AddChatRoomResponseDto> result = new ArrayList<>();
        for (ChatRoom chatRoom : chatRooms) {
            result.add(AddChatRoomResponseDto.builder()
                    .id(chatRoom.getId())
